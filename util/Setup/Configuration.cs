...
public class Configuration
{
    ...
    public bool GenerateComposeConfig {
        get;
        set;
    } = true;
    ...
    public bool GenerateNginxConfig {
        get;
        set;
    } = true;
    ...
    public bool SslManagedLetsEncrypt {
        get;
        set;
    }
    ...
    [Description("Diffie Hellman ephemeral parameters\n" +
                 ...
                 "Note: Path uses the container's ssl directory. The `./ssl` host directory is mapped to\n" +
                 "`/etc/ssl` within the container.")]
    public string SslDiffieHellmanPath {
        get;
        set;
    }
    ...
    public bool DatabaseDockerVolume {
        get;
        set;
    }
