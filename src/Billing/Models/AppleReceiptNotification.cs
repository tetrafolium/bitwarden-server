...
public class AppleReceiptNotification
{
    ...
    public DateTime? AutoRenewStatusChangeDate {
        get;
        set;
    }
    ...
    public AppleReceiptNotificationInfo LatestReceiptInfo {
        get;
        set;
    }
    [JsonProperty("latest_expired_receipt")]
    public string LatestExpiredReceipt {
        get;
        set;
    }
    [JsonProperty("latest_expired_receipt_info")]
    public AppleReceiptNotificationInfo LatestExpiredReceiptInfo {
        get;
        set;
    }
