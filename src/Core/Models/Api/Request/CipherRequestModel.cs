...
public class CipherRequestModel
{
    ...
    public IEnumerable<CipherFieldModel> Fields {
        get;
        set;
    }
    public IEnumerable<CipherPasswordHistoryModel> PasswordHistory {
        get;
        set;
    }
    [Obsolete]
    ...
    public Dictionary<string, CipherAttachmentModel> Attachments2 {
        get;
        set;
    }

    public CipherLoginModel Login {
        get;
        set;
    }
    public CipherCardModel Card {
        get;
        set;
    }
    public CipherIdentityModel Identity {
        get;
        set;
    }
    public CipherSecureNoteModel SecureNote {
        get;
        set;
    }
...
{
    public IEnumerable<Guid> CollectionIds {
        get;
        set;
    }
    [Required]
    public CipherRequestModel Cipher {
        get;
        set;
    }
...
{
    [Required]
    public IEnumerable<string> CollectionIds {
        get;
        set;
    }
    [Required]
...
public class CipherBulkShareRequestModel : IValidatableObject
{
    ...
    [Required]
    public IEnumerable<CipherWithIdRequestModel> Ciphers {
        get;
        set;
    }
