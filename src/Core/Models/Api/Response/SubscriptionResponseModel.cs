...
public BillingSubscriptionUpcomingInvoice UpcomingInvoice {
	get;
	set;
}
...
public bool UsingInAppPurchase {
	get;
	set;
}
}
...
public IEnumerable<BillingSubscriptionItem> Items {
	get;
	set;
